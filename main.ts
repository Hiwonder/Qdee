 ...
 */
  function qdee_ext_output(pin: number, out: number)
  {
    ...
    */
     ...
     * Set the color of the colored lights, after finished the setting please perform  the display of colored lights.
     */
    //% weight=68 blockId=qdee_belt_setPixelRGBSingle block="Set light belt index(0~29)|%lightoffset|color to %rgb"
     ...
     * Set the color of the colored lights, after finished the setting please perform  the display of colored lights.
     */
    //% weight=67 blockId=qdee_belt_setPixelRGBIndex block="Set light belt|%lightoffset|color to %rgb"
     ...
     * Display the colored lights, and set the color of the colored lights to match the use. After setting the color of the colored lights, the color of the lights must be displayed.
     */
    //% weight=66 blockId=qdee_belt_showLight block="Show light belt"
     ...
     * Clear the color of the colored lights and turn off the lights.
     */
    //% weight=65 blockGap=50 blockId=qdee_belt_clearLight block="Clear light belt"
     ...
     */
    //% weight=64 blockId=qdee_analyzeBluetoothCmd block="Get bluetooth command type %str"
    ...
    * @param index number of the learn code in 1-3. eg: 1
     */
    //% weight=63  blockId=qdee_getArgs block="Get bluetooth command|%str|argument at %index"
     ...
     */
    //% weight=62 blockId=qdee_getBluetoothCmdtype block="Bluetooth command type %type"
     ...
     */
    //% weight=61 blockId=qdee_getRunCarType block="Car run type %type"
    ...
    */
    //% weight=60 blockId=qdee_show_expressions block="Qdee show facial expressions %type"
     ...
     * Set Qdee play tone
     */
    //% weight=59 blockId=qdee_playTone block="Qdee play |tone %tone|and beats %rhythm"
     ...
     */
    //% weight=58 blockId=qdee_convertUltrasonic block="Convert ultrasonic distance %data"
     ...
     */
    //% weight=57 blockId=qdee_convertTemperature block="Convert temperature %data"
     ...
     */
    //% weight=56 blockId=qdee_convertLight block="Convert sound %data"
     ...
     */
    //% weight=55 blockId=qdee_convertLight block="Convert light %data"
     ...
     * Connect to the wifi
     */
    //% weight=53 blockId=qdee_connectWifi block="Connect to the Wifi,name|%ssid|and password %passwrd"
     ...
     */
    //% weight=52 blockId=qdee_isConnectedServer block="Device is connected to server?"
     ...
     */
    //% weight=51 blockId=qdee_send_getMac block="Send pair command"
     ...
     * @param body code to run when event is raised
     */
    //% weight=50 blockId=onQdee_getMac block="On Qdee get device id"
     ...
     */
    //% weight=49 blockId=qdee_getMacAddress block="Get device id"
     ...
     * Send sofa status
     */
    //% weight=48 blockId=qdee_sendSofa block="Send sofa command %sofa"
